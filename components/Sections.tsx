  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      sections.forEach((section, i) => {
        /* content panels ride in from the right edge of the screen */
        ...
        /* giant hollow word sweeps right -> left behind everything */
      ...
      /* hero text drifts up + fades as you leave section 1 */
      if (!reduce) {
        gsap.to("[data-hero]", {
          y: "-18vh",
          opacity: 0,
  ...
  return (
    <div ref={root} className="relative z-20 w-screen">
      ...
      <div className="pointer-events-none fixed inset-x-0 top-0 z-40 flex items-center justify-between px-6 py-5 md:px-10">
        ...
        <span className="font-body text-[11px] uppercase tracking-[0.35em] text-cream/50">
          Row 7 · Small batch
        </span>
      </div>
      ...
      >
        <div
          data-bgword
          className="outline-word outline-word--ember absolute top-1/2 -translate-y-1/2 text-[34vw] leading-none"
        >
          FARMEX
        </div>

        <div data-hero className="relative z-10 mt-[52vh] text-center md:mt-[56vh]">
          <p className="font-body text-xs uppercase tracking-[0.5em] text-honey">
            Grown · Fermented · Bottled
          </p>
          <h1 className="mt-3 font-display text-[13vw] leading-[0.9] text-cream md:text-[8vw]">
            FARM-FIRED
            <br />
            <span className="text-ember">HOT SAUCE</span>
          </h1>
        </div>

        <div className="absolute bottom-8 left-1/2 z-10 -translate-x-1/2 text-center">
          <p className="font-body text-[11px] uppercase tracking-[0.4em] text-cream/60">
            Scroll to taste
          </p>
      ...
      {/* ============ SECTION 2 — DETAILS (text LEFT, bottle right) == */}
      <section
        data-section="1"
      ...
      >
        <div
          data-bgword
          className="outline-word absolute top-1/2 -translate-y-1/2 text-[26vw] leading-none"
        >
          ONE&nbsp;FIELD&nbsp;ONE&nbsp;BOTTLE
        </div>
        ...
        <div className="relative z-10 w-full px-6 md:w-1/2 md:pl-[7vw] md:pr-0">
          <div data-panel>
            ...
            <h2 className="mt-4 font-display text-4xl leading-[1.02] text-cream md:text-6xl">
              EVERYTHING IN IT GREW <span className="text-field">40&nbsp;FT</span> FROM THE KETTLE
            </h2>
          </div>
          <ul data-panel className="mt-8 space-y-4 font-body text-sm text-cream/75 md:text-base">
            <li className="flex gap-4 border-b border-cream/10 pb-3">
        ...
        {/* right half stays clear for the bottle */}
        <div className="hidden md:block md:w-1/2" aria-hidden />
      </section>

      {/* ============ SECTION 3 — HEAT (text RIGHT, bottle left) ===== */}
      <section
        data-section="2"
      ...
      >
        <div
          data-bgword
          className="outline-word outline-word--ember absolute top-1/2 -translate-y-1/2 text-[30vw] leading-none"
        >
          HEAT&nbsp;HEAT&nbsp;HEAT
        </div>
        ...
        <div className="relative z-10 w-full px-6 md:w-1/2 md:pl-0 md:pr-[7vw]">
          <div data-panel>
            ...
            <h2 className="mt-4 font-display text-4xl leading-[1.02] text-cream md:text-6xl">
              SLOW BURN, <span className="text-ember">LONG FINISH</span>
            </h2>
          </div>

          <div data-panel className="mt-10 grid grid-cols-3 gap-6">
            <div>
              <p className="font-display text-3xl text-ember md:text-5xl">62K</p>
              <p className="mt-2 font-body text-[11px] uppercase tracking-[0.25em] text-cream/60">
                Scoville
              </p>
            </div>
            <div>
              <p className="font-display text-3xl text-honey md:text-5xl">21</p>
              <p className="mt-2 font-body text-[11px] uppercase tracking-[0.25em] text-cream/60">
                Days fermented
              </p>
            </div>
          ...
          <div data-panel className="mt-10">
            <div className="h-2 w-full overflow-hidden rounded-full bg-cream/10">
              <div className="h-full w-[72%] rounded-full bg-gradient-to-r from-honey via-ember to-chili" />
            </div>
            <div className="mt-2 flex justify-between font-body text-[10px] uppercase tracking-[0.3em] text-cream/50">
              <span>Warm</span>
              <span>Farmex</span>
              <span>Regret</span>
            </div>
      ...
      >
        <div
          data-bgword
          className="outline-word absolute top-1/2 -translate-y-1/2 text-[30vw] leading-none"
        >
          GET&nbsp;THE&nbsp;BOTTLE
        </div>

        <div className="relative z-10 text-center">
          <p data-panel className="font-body text-xs uppercase tracking-[0.5em] text-honey">
            03 — Batch №14 · 480 bottles
          </p>
          <h2
            data-panel
            className="mt-3 font-display text-4xl leading-none text-cream md:text-6xl"
          >
            TAKE ONE HOME
          </h2>
          <div data-panel className="mt-7 flex items-center justify-center gap-4">
            ...
            <button className="pointer-events-auto rounded-full border border-cream/25 px-8 py-4 font-body text-sm text-cream/80 transition-colors hover:border-ember hover:text-ember">
              Find a stockist
            </button>
          </div>
          <p data-panel className="mt-6 font-body text-[11px] uppercase tracking-[0.3em] text-cream/40">
